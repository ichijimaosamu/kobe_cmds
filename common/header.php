...
<h1 class="header__logo"><a href=""><img src="<?php echo $base_url . '/'; ?>img/header_logo.png" alt="CMDS 神戸大学"></a><small>Society5.0 と地方創生を加速させる<br>
次世代DXリーダー育成プログラム事業</small></h1>

<p class="header__contact"><a href="<?php echo $base_url . '/'; ?>contact/">お問い合わせ</a></p>
</div>
...
<li class="header__nav__item"><a href="<?php echo $base_url . '/'; ?>leader/"><span class="header__nav__item__inner<?php if(strpos($URI,'/leader/') !== false) {echo ' -is-active'; } ?>">次世代DXリーダー育成</span></a></li>
<li class="header__nav__item"><a href="<?php echo $base_url . '/'; ?>curriculum"><span class="header__nav__item__inner<?php if(strpos($URI,'/curriculum/') !== false) {echo ' -is-active'; } ?>">カリキュラム</span></a></li>
